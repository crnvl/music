...
// DRUMS
_$: s("crate_bd:24!4").duckorbit("2:3:4").duckattack(bpm / 512).duckdepth(.85)
...
const bassline = "<3 5 7 9>@3 <10 12 14 16>"
const melody   = "<12 12 10 10>@2 <7> <9 3>"
const arp      =  "<14 16 12 10>*8".sub(7)
